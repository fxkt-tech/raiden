...
func newMessage(db *gorm.DB) message {
	...
	_message.MessageID = field.NewInt32(tableName, "message_id")
	_message.SenderUID = field.NewInt32(tableName, "sender_uid")
	_message.RecverUID = field.NewInt32(tableName, "recver_uid")
	_message.Content = field.NewString(tableName, "content")
	_message.Ctime = field.NewTime(tableName, "ctime")
...
type message struct {
	...
	SenderUID field.Int32
	RecverUID field.Int32
...
func (m *message) updateTableName(table string) *message {
	...
	m.MessageID = field.NewInt32(table, "message_id")
	m.SenderUID = field.NewInt32(table, "sender_uid")
	m.RecverUID = field.NewInt32(table, "recver_uid")
	m.Content = field.NewString(table, "content")
	m.Ctime = field.NewTime(table, "ctime")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["recver_uid"] = m.RecverUID
