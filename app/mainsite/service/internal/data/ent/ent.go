...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		rdmessage.Table:           rdmessage.ValidColumn,
		rdmoment.Table:            rdmoment.ValidColumn,
		rdrmomentsfollowing.Table: rdrmomentsfollowing.ValidColumn,
		rdruserfollowers.Table:    rdruserfollowers.ValidColumn,
		rdruserfollowing.Table:    rdruserfollowing.ValidColumn,
		rduser.Table:              rduser.ValidColumn,
	}
