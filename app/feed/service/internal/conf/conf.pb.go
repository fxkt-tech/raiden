...
type Data struct {
	...
	ExtApi   *Data_ExtAPI   `protobuf:"bytes,3,opt,name=ext_api,json=extApi,proto3" json:"ext_api,omitempty"`
}
...
func (x *Data) GetExtApi() *Data_ExtAPI {
	if x != nil {
		return x.ExtApi
	}
	return nil
...
type Data_ExtAPI struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserEp string `protobuf:"bytes,1,opt,name=user_ep,json=userEp,proto3" json:"user_ep,omitempty"`
}

func (x *Data_ExtAPI) Reset() {
	*x = Data_ExtAPI{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_ExtAPI) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_ExtAPI) ProtoMessage() {}

func (x *Data_ExtAPI) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_ExtAPI.ProtoReflect.Descriptor instead.
func (*Data_ExtAPI) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_ExtAPI) GetUserEp() string {
	if x != nil {
		return x.UserEp
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0xb2, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74,
	...
	0x0a, 0x07, 0x65, 0x78, 0x74, 0x5f, 0x61, 0x70, 0x69, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x17, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74,
	0x61, 0x2e, 0x45, 0x78, 0x74, 0x41, 0x50, 0x49, 0x52, 0x06, 0x65, 0x78, 0x74, 0x41, 0x70, 0x69,
	...
	0x75, 0x74, 0x1a, 0x21, 0x0a, 0x06, 0x45, 0x78, 0x74, 0x41, 0x50, 0x49, 0x12, 0x17, 0x0a, 0x07,
	0x75, 0x73, 0x65, 0x72, 0x5f, 0x65, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75,
	0x73, 0x65, 0x72, 0x45, 0x70, 0x42, 0x25, 0x5a, 0x23, 0x66, 0x78, 0x6b, 0x74, 0x2e, 0x74, 0x65,
	0x63, 0x68, 0x2f, 0x72, 0x61, 0x69, 0x64, 0x65, 0x6e, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_ExtAPI)(nil),         // 7: kratos.api.Data.ExtAPI
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.ext_api:type_name -> kratos.api.Data.ExtAPI
